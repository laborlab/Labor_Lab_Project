...
There is a low percentage of missing values for hourly and annual wages.
...
Once we filter the data for just the D.C area the data becomes scarce. This might hinder our ability to build a predictive model.

```{r}
df_final_dc %>%
  datatable(colnames = c("Location",'Title', 'Hourly Wage', 'Annual Wage'),caption = "DC Area")
```
